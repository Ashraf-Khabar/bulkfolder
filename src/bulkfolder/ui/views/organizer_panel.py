...
class OrganizerPanel(ctk.CTkFrame):
    def __init__(
        ...
        self.btn_scan.grid(row=6, column=0, sticky="ew", padx=16, pady=(0, 10))
        ...
        self.btn_apply.grid(row=7, column=0, sticky="ew", padx=16, pady=(0, 10))
        ...
        self.btn_undo.grid(row=8, column=0, sticky="ew", padx=16, pady=(0, 16))
